...
VALUES ('apprentissage automatique, introduction', 'Introduction à l''apprentissage automatique', 1, 'dsa.jpg', 'Ce contenu présente une introduction générale à l''apprentissage automatique.',
        'L''apprentissage automatique est une branche de l''intelligence artificielle.', '2023-01-01', '1.jpg');

INSERT INTO Paragraphe (idContenue, imagepara, titrepara, descriptione)
VALUES (1, '2.jpg', 'Qu''est-ce que l''apprentissage automatique ?',
...
INSERT INTO Paragraphe (idContenue, imagepara, titrepara, descriptione)
VALUES (1, '3.jpg', 'Types d''apprentissage automatique', 'Il existe différents types d''apprentissage automatique, notamment l''apprentissage supervisé, l''apprentissage non supervisé et l''apprentissage par renforcement.');

INSERT INTO Contenue (keywords, titre, idcategorie, descriimage, resume, snippet, datepublication, image)
VALUES ('réseaux de neurones artificiels, deep learning', 'Réseaux de neurones artificiels', 1, 'image_intro2.jpg', 'Ce contenu présente les réseaux de neurones artificiels et le concept de deep learning.', 'Les réseaux de neurones artificiels sont des modèles informatiques .', '2023-02-01', '4.jpg');
...
INSERT INTO Paragraphe (idContenue, imagepara, titrepara, descriptione)
VALUES (2, '6.jpg', 'Applications du deep learning', 'Le deep learning a révolutionné de nombreux domaines tels que la vision par ordinateur, la reconnaissance vocale, la traduction automatique et la recommandation de contenu.');
...
INSERT INTO Contenue (keywords, titre, idcategorie, descriimage, resume, snippet, datepublication, image)
VALUES ('traitement du langage naturel, NLP', 'Introduction au traitement du langage naturel', 2, 'image_intro3.jpg', 'Ce contenu présente une introduction au traitement du langage naturel (NLP).', 'Le traitement du langage naturel est une branche de l''intelligence artificielle qui vise à permettre aux machines de comprendre, d''interpréter et de générer un langage humain. Cela implique la reconnaissance et l''analyse des mots, de la syntaxe, de la sémantique et du contexte dans les données textuelles.', '2023-03-01', 'image_contenu3.jpg');

INSERT INTO Paragraphe (idContenue, imagepara, titrepara, descriptione)
VALUES (3, 'image_para1.jpg', 'Les défis du traitement du langage naturel', 'Le traitement du langage naturel présente de nombreux défis, notamment la compréhension du langage ambigu, la gestion des erreurs orthographiques et grammaticales, ainsi que la prise en compte du contexte et de l''ambiguïté dans les interprétations. Les tâches courantes en NLP incluent la classification de texte, l''analyse des sentiments, la traduction automatique et la génération de texte.');

INSERT INTO Paragraphe (idContenue, imagepara, titrepara, descriptione)
VALUES (3, 'image_para2.jpg', 'Applications du traitement du langage naturel', 'Le traitement du langage naturel trouve des applications dans de nombreux domaines, tels que les chatbots, l''analyse des opinions sur les réseaux sociaux, la recherche d''informations et la rédaction automatique. Les chatbots utilisent des techniques de NLP pour comprendre et répondre aux requêtes des utilisateurs de manière naturelle. L''analyse des opinions permet d''extraire des informations utiles à partir des commentaires et des avis des utilisateurs sur les médias sociaux. La recherche d''informations utilise des techniques de NLP pour analyser et organiser les documents afin de fournir des résultats pertinents aux requêtes des utilisateurs.');
